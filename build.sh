...
SOURCE_FILES="src/main.c src/todoroutes.c src/todo.c"  # Adjust file paths as needed
...
clang -o "$OUTPUT_EXECUTABLE" $SOURCE_FILES -lmicrohttpd -lsqlite3 -ljansson -I/usr/local/include -L/usr/local/lib
